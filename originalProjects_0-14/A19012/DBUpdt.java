...
public class DBUpdt implements DBTemplate
{
 // Class Level Variables
   Connection dbConn;      //java needs a connection to the ms access database
   ...
   String     dbKeyField;  //the string represents the name of the key field, in this case stationID
   ...
   */  
   public void openConnection(String strDataSourceName)
   {
      ...
      {  //protocal, subrprotocal, etc
         ...
         dbConn=DriverManager.getConnection("jdbc:odbc:" + strDataSourceName);
         if (dbConn == null)
         {  
